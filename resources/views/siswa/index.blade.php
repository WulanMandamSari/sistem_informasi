        ...
        <div class="row">
          <div class="col-md-12">
            <div class="panel panel-default">
              ...
              @if (auth()->user()->role =="admin")
                <a href="/siswa/create" class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp;Input</a>
              @endif 
                ...
                <table class="table table-striped" id="table-data">
                  ...
                  @foreach($siswa as $i => $p)
                    <tr>
                        ...
                        <td>
                           @if (auth()->user()->role =="admin")
                            <a href="/siswa/edit/{{$p->id}}"><i class="fa fa-edit fa-lg"></i></a>
                            <a href="/siswa/destroy/{{$p->id}}" ><i class="fa fa-trash fa-lg" <i class="fa-regular fa-pen-to-square fa-lg" style="color: #ff0000;"></i></i></a>
                           @endif
                        </td>
                    </tr>
                  @endforeach

...
<body class="hold-transition sidebar-mini">
  <div class="wrapper">
    ...
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-12">
              <h1 class="m-0"><center><font color="black">EDIT DATA SISWA</center></center></h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
          ...
          <form method="post" action="/siswa/update/{{ $siswa->id }}">
            ...
            {{ method_field('PUT') }}
                  ...
                  <div class="form-group">
                    <label class="control-label col-md-8">NISN</label>
                    <div class="col-md-20">
                  ...
                  <div class="form-group">
                    <label class="control-label col-md-8">Nama Siswa</label>
                    <div class="col-md-20">
                  ...
                  <div class="form-group">
                    <label class="control-label col-md-8">Kelas</label>
                    <div class="col-md-20">
                  ...
                  <div class="form-group">
                            ...
                            <p>
                            <input type="radio" value="Laki-laki" name="jenkel">&nbsp; Laki-laki</input> &nbsp; &nbsp;
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <label class="control-label col-md-8">Tempat/Tanggal Lahir</label>
                    <div class="col-md-20">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-20">
                      <input type="text" class="form-control" name="no_handphone" value="{{ $siswa->no_handphone }}">
              ...
              <a href="/siswa" class="btn btn-outline-danger">Kembali</a>
              </div>
            </form>
          </div>
        </div>

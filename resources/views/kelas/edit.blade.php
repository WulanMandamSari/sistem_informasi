...
<body class="hold-transition sidebar-mini">
  <div class="wrapper">
    ...
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-12">
              <h1 class="m-0"><center><font color="black">EDIT DATA KELAS</font></center></h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
        ...
        <div class="card mt-4">
          ...
          {{ method_field('PUT') }}
              ...
              <div class="form-group">
                    ...
                    <font color="red"><h6>&nbsp;&nbsp;*Wajib di isi*</h6></font>
                    <div class="col-md-20">
                      <select class="form-control" name="id_pengajar" id="id_pengajar">
                        <option>Silahkan Pilih</option>
                        @foreach($pengajar as $item)
                        <option value="{{ $item->id ? $item->id : ""}}" @if($kelas->id_pengajar === $item->id_pengajar) selected @endif >{{ $item->nama_pengajar}}</option>
                        @endforeach
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <label class="control-label col-md-8">Wali Kelas </label>
                    <div class="col-md-20">
              ...
              <a href="/kelas" class="btn btn-outline-danger">Kembali</a>
              </div>
            </form>
          </div>
        </div>

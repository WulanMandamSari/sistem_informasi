...
<body class="hold-transition sidebar-mini">
  <div class="wrapper">
    ...
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-12">
              <h1 class="m-0"><center>Tambah Data Kelas</center></h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="panel panel-default">
              ...
              <div class="card-body">
                <form method="post" action="/kelas/store" enctype="multipart/form-data"> {{ csrf_field() }}
                  
                <div class="form-group">
                    <label class="control-label col-md-8">Nama Pengajar</label>
                    <div class="col-md-20">
                      <select name="id_pengajar" class="form-control">
                        @foreach($pengajar as $key => $val):
                        <option value="<?= $val['id'] ?>">{{$val['nama_pengajar']}}</option>
                        @endforeach
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <label class="control-label col-md-8">Nama Kelas</label>
                    <div class="col-md-20">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-20">
                      <input type="text" class="form-control" name="jumlah_siswa" value="{{old('jumlah_siswa')}}">

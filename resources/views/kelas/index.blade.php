...
<body class="hold-transition sidebar-mini">
  <div class="wrapper">
    ...
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-12">
              <h1 class="m-0"><center><font color="black">DATA WALI KELAS</font></center></h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
          ...
          <div class="col-md-12">
            <div class="panel panel-default">
              <div class="panel-head container-fluid" style="margin-top: 10px;">
                <a href="/kelas/create" class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp;Input</a>
                ...
                <table class="table table-striped" id="table-data">
                  ...
                  @foreach($kelas as $i => $p)
                    <tr>
                        ...
                        <td>
                            <a href="/kelas/edit/{{$p->id}}"><i class="fa fa-edit fa-lg"></i></a>
                            <a href="/kelas/destroy/{{$p->id}}" ><i class="fa fa-trash fa-lg" <i class="fa-regular fa-pen-to-square fa-lg" style="color: #ff0000;"></i></i></a>
                        </td>
                    </tr>
                  @endforeach
                  </tbody>

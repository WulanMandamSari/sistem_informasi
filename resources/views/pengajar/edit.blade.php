...
<body class="hold-transition sidebar-mini">
  <div class="wrapper">
    ...
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-12">
              <h1 class="m-0"><center><font color="black">EDIT DATA PENGAJAR</font></center></h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
          ...
          <div class="row">
            <div class="col-md-12"> 
              <div class="panel panel-default"> 
                ...
                <p></p>
          <div class="card-body">
          <form method="post" action="/pengajar/update/{{ $pengajar->id }}">
            {{ csrf_field() }}
            {{ method_field('PUT') }}
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-20">
                      <input type="text" class="form-control" name="nama_pengajar" value="{{ $pengajar->nama_pengajar }}">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-20">
                      <input type="text" class="form-control" name="no_handphone" value="{{ $pengajar->no_handphone }}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-20">
                      <input type="text" class="form-control" name="tugas" value="{{ $pengajar->tugas }}">
                      @if($errors->has('tugas'))
                          <div class="text-danger">
                            {{ $errors->first('tugas')}}
                          </div>

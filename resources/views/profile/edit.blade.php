...
<body class="hold-transition sidebar-mini">
  <div class="wrapper">
    ...
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-12">
              <h1 class="m-0"><center><font color="black">EDIT PROFILE SEKOLAH</font></center></h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
          ...
          <form method="post" action="/profile/update/{{ $profile->id }}">
            ...
            {{ method_field('PUT') }}
                  ...
                  <div class="form-group">
                    <label class="control-label col-md-8">NPSN</label>
                    <div class="col-md-20">
                      <input type="text" class="form-control" name="npsn" value="{{ $profile->npsn }}">
                      @if($errors->has('npsn'))
                  ...
                  <div class="form-group">
                    <label class="control-label col-md-8">Nama Sekolah</label>
                    <div class="col-md-20">
                      <input type="text" class="form-control" name="nama_sekolah" value="{{ $profile->nama_sekolah }}">
                ...
                <div class="form-group">
                    <label class="control-label col-md-8">Jurusan</label>
                    <div class="col-md-20">
                      <input type="text" class="form-control" name="jurusan" value="{{ $profile->jurusan }}">
                  ...
                  <div class="form-group">
                    <label class="control-label col-md-8">Nama Kepala Sekolah</label>
                    <div class="col-md-20">
                      <input type="text" class="form-control" name="kepsek" value="{{ $profile->kepsek }}">
                  ...
                  <div class="form-group">
                    <label class="control-label col-md-8">Website</label>
                    <div class="col-md-20">

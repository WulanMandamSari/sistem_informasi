        ...
        <div class="row">
          <div class="col-md-12">
            <div class="panel panel-default">
              ...
              <p align="center">
              SMK Informatika Utama, berdiri sejak tahun 2005. Dengan jurusan atau studi dibidang Rekayasa Perangkat Lunak. 
              </p>
              <img src="{{asset('Gambar/pict.jpeg')}}" width="31%" height="30%"></img>&nbsp;&nbsp;
              <img src="{{asset('Gambar/pict2.jpeg')}}" width="35%" height="28%"></img>&nbsp;&nbsp;
              <img src="{{asset('Gambar/pict3.jpeg')}}" width="29%" height="35%">
              <br/>
              <br/>
              @foreach ($profile as $i => $p)
                <tr>
                    <td> 
                    <a href="/profile/show/{{$p->id}}" class="btn btn-outline-danger">Profile SMK</a>
                    </td>
                </tr>
              @endforeach
              <br/>
